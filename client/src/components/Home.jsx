...
import { getMe, likeUser, logoutUser, rejectUser, updateLocation } from "../redux/apiCalls/apiCalls";
...
const Home = () => {
  ...
  const handleLike = async () => {
    const status = await likeUser(dispatch, preferredUsers[0]?.email, currentUser, setMatchedUser, navigate);
  ...
  return (<div className="grid grid-cols-12 ">
    {/* Top Bar */}
    <div
      className="col-span-12 h-16 bg-stone-50 sticky top-0 shadow-sm flex px-6 py-2 z-10 lg:px-20 justify-between items-center">
      {/* Home Icon */}
    ...
    {sidebarOpen && (
      <div className="overflow-auto absolute top-[78px] z-10 shadow-sm lg:hidden md:col-span-5 bg-gray-200">
        <div className="p-2">
          <button onClick={toggleSidebar} className="text-2xl absolute top-0 right-0">
            <FaTimes/>
          </button>
