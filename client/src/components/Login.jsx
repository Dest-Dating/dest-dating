...
function Login() {
  ...
  return (<div className="flex h-screen justify-center items-center bg-violet-100">
    <div className="max-w-xl w-full flex justify-between">
      {/* Left side: Image */}
      <div
        className={`hidden lg:block w-4/5 ${imageLoaded ? "opacity-100 transition-opacity duration-1000" : "opacity-0"}`}
      >
        <img
          src={loginImage}
          alt="Love"
      ...
      <div className="bg-white rounded-lg shadow-md w-full p-10">
        ...
        >
          <div className="mb-5">
            <label htmlFor="email" className="block  text-lg mb-2 font-medium text-gray-900 dark:text-white">Your
              email</label>
          ...
          <div className="mb-5">
            <label htmlFor="password" className="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Your
              password</label>
          ...
          <button type="submit"
                  className="text-white my-3 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit
          </button>
