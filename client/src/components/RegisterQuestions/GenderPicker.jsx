      ...
      >
        ...
        >
          ...
          <div className="flex flex-col *:mx-2 justify-center content-center w-full mb-4 md:flex-row">
            <button
              className={`px-4 py-2 rounded-lg border ${selectedGender === "Male" ? "bg-pink-500 text-white" : "border-gray-300"}`}
              onClick={() => handleGenderSelect("Male")}
            >
              Male
            </button>
            <button
              className={`px-4 py-2 rounded-lg border mb-2 md:mb-0 ${selectedGender === "Female" ? "bg-pink-500 text-white" : "border-gray-300"}`}
              onClick={() => handleGenderSelect("Female")}
            >
              Female
            </button>
            <button
              className={`px-4 py-2 rounded-lg border ${selectedGender === "Non Binary" ? "bg-pink-500 text-white" : "border-gray-300"}`}
