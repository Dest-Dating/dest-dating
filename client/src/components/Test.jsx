  ...
  return (<div className="flex justify-center items-center min-h-[100vh]">
    ...
    <div className="relative">
      <div>
        <div
          ...
          <div className="relative backdrop-blur-sm">
            ...
            <div name="header"
              ...
              <div name="username" className="text-xl font-bold  font-handwritten">{user.name}</div>
            ...
            {(user.photosLink).map((obj) => {
              return (<div
                ...
                <div className="h-[500px] min-w-[300px] flex">
                  <img className="object-cover h-[500px] w-[300px] object-center"
                       src={user.photosLink[obj.index].photoLink} alt="" />
                </div>
                <div className="p-3">
        ...
        <div name="up down" className={`absolute flex flex-col gap-4 right-5 top-[70%]`}>
          <div name="accept" onClick={(e) => handleViewChange(-1)}
          ...
          <div name="accept" onClick={(e) => handleViewChange(1)}
               className={`hover:scale-105 active:scale-100 w-6 h-6 border rounded-full flex justify-center items-center shadow-xl  border-stone-200 bg-white ${view === user.photosLink.length && "opacity-0"}`}>
            <FaAngleDown />
          </div>
        </div>

        <div name="controls" className="absolute left-[50%] -translate-x-1/2 flex gap-10 -bottom-10 ">
          <div name="accept"
